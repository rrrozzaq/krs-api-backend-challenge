                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-v1-login">POST api/v1/login</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-students--nim--krs-current">
                                <a href="#endpoints-GETapi-v1-students--nim--krs-current">GET api/v1/students/{nim}/krs/current</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-students--nim--courses-available">
                                <a href="#endpoints-GETapi-v1-students--nim--courses-available">GET api/v1/students/{nim}/courses/available</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-students--nim--krs-courses--schedule_id-">
                                <a href="#endpoints-DELETEapi-v1-students--nim--krs-courses--schedule_id-">DELETE api/v1/students/{nim}/krs/courses/{schedule_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-students--nim--krs-status">
                                <a href="#endpoints-GETapi-v1-students--nim--krs-status">GET api/v1/students/{nim}/krs/status</a>
                            </li>
...
<p>Example: <code>O[2UZ5ij-e/dl4m{o,</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-students--nim--krs-current">GET api/v1/students/{nim}/krs/current</h2>
...
<div class="bash-example">
    ...
    --get "http://localhost/api/v1/students/consequatur/krs/current" \
    --header "Content-Type: application/json" \
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/students/consequatur/krs/current"
);
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-students--nim--courses-available">GET api/v1/students/{nim}/courses/available</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/students/consequatur/courses/available" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/students/consequatur/courses/available"
);
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-students--nim--krs-courses--schedule_id-">DELETE api/v1/students/{nim}/krs/courses/{schedule_id}</h2>
...
<div class="bash-example">
    ...
    "http://localhost/api/v1/students/consequatur/krs/courses/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="schedule_id"                data-endpoint="DELETEapi-v1-students--nim--krs-courses--schedule_id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the schedule. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-students--nim--krs-status">GET api/v1/students/{nim}/krs/status</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/students/consequatur/krs/status" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/students/consequatur/krs/status"
);
